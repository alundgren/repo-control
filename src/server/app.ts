...
export async function createApp({ webRoot, logger, cache, syncService, refreshService, diffClient, reviewService, mergeService, priorityService, eventHub, webhookService, artifactService, logEvent }: AppOptions) {
  const app = logger
  ...
  await app.register(apiPlugin, { prefix: "/api", cache, syncService, refreshService, diffClient, reviewService, mergeService, priorityService, eventHub, logEvent });
